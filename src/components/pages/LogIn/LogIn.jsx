...
const LogIn = () => {
    return (
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none max-w-screen-lg bg-slate-50 mx-auto">
            ...
            <form className="mt-8 mb-2 w-80  sm:w-96 mx-auto">
